                    ...
                    <td>
                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <p style="color: #aba8a8;">Thank you for borrowing: </p>
                                        <p><span style="color: #168eea;">{{ $borrow->fname }} {{ $borrow->lname }}</span></p>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <h2 style="text-transform: capitalize; font-style: italic; color: #444444;">Book Requested Details</h2>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <table class="order-detail" width="100%">
                            <tbody>
                                <tr width="100vh">
                                    <td colspan="2" style="line-height: 49px; font-size: 13px; color: #000000; padding-left: 20px; text-align: left; border-right: unset;">Title:</td>
                                    <td class="price" colspan="3" style="line-height: 49px; text-align: right; padding-right: 28px; font-size: 13px; color: #000000; text-align: right; border-left: unset;"><b>{{ $book->title }}</b></td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="line-height: 49px; font-size: 13px; color: #000000; padding-left: 20px; text-align: left; border-right: unset;">Author :</td>
                                    <td class="price" colspan="3" style="line-height: 49px; text-align: right; padding-right: 28px; font-size: 13px; color: #000000; text-align: right; border-left: unset;"><b>{{ $book->author }}</b></td>
                                </tr>
                                <tr>
                                    <td colspan="2" style="line-height: 49px; font-family: Arial; font-size: 13px; color: #000000; padding-left: 20px; text-align: left; border-right: unset;">Year Release :</td>
                                    <td class="price" colspan="3" style="line-height: 49px; text-align: right; padding-right: 28px; font-size: 13px; color: #000000; text-align: right; border-left: unset;"><b>{{ $book->year }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                                ...
                                <tr>
                                    <td style="background-color: #fafafa; padding: 15px; letter-spacing: 0.3px; width: 50%;">
                                        ...
                                        <p style="text-align: left; font-weight: normal; font-size: 14px; color: #aba8a8; line-height: 21px; margin-top: 0;">
                                            Go to librarian or Staff of Library<br />
                                            to get your requested book/s<br />
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
                                    ...
                                    <td style="padding: 30px;">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin: 20px auto 0;">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><a href="{{ route('borrow') }}" style="color: #168eea; font-size: 14px; text-transform: capitalize; font-weight: 600; margin: 0; text-decoration: underline;">Go back to Borrowing Page</a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </td>
