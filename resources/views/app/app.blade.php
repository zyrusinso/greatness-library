        ...
        <div class="col-xl-12 col-md-12 box-col-12 des-xl-50 profile-greeting-width">
            <div class="card profile-greeting">
                ...
                <div class="card-body text-center p-t-0">
                    ...
                    <p>Welcome to the viho Family! we are glad that you are visite this dashboard. we will be happy to
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-xs-12 col-md-6 col-sm-6">
                            <div class="cal-info text-center">
                                <div>
                                    <h2>{{ date('d') }}</h2>
                                    <div class="d-inline-block"><span class="b-r-dark pe-3">{{ date('F') }}</span><span
                                            class="ps-3">{{ date('Y') }}</span></div>
                                    <p class="f-16">There's no library visitors today! Check later</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-xs-12 col-md-6 col-sm-6">
                ...
                <div class="mobile-clock-widget">
                    ...
                    <div>
                        <ul class="clock" id="clock">
                            <li class="hour" id="hour" style="transform: rotate(520deg);"></li>
                            <li class="min" id="min" style="transform: rotate(120deg);"></li>
                            <li class="sec" id="sec" style="transform: rotate(294deg);"></li>
                        </ul>
                        <div class="date f-24 mb-2" id="date"><span id="monthDay"></span><span id="year">,&nbsp;</span>
                        </div>
                        <div>
                            <p class="m-0 f-14 text-light">Quezon City, Philippines</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body align-self-center text-white">
                                ...
                                <p class="m-0 f-14">Metro Manila</p>
                            </div>
                        </div>
                        <div class="media">
                            ...
                            <div class="media-body align-self-center text-white">
                                ...
                                <p class="m-0 f-14">Quezon City</p>
                            </div>
                        </div>
      ...
      &lt;/div&gt;</code></pre>
        ...
        <div class="col-xl-4 col-md-6 box-col-6">
            <div class="card custom-card">
                <div class="card-header pb-0"><img class="img-fluid" src="{{asset('assets/images/user-card/3.jpg')}}"
                        alt=""></div>
        ...
        <div class="col-xl-6 xl-100 box-col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="code-box-copy">
                        <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#products-cart"
                            title="Copy"><i class="icofont icofont-copy-alt"></i></button>
        ...
        <div class="col-xl-6 xl-100 box-col-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="code-box-copy">
                        <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#emplotee-status"
                            title="Copy"><i class="icofont icofont-copy-alt"></i></button>
