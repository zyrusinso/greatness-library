<header class="main-nav @if(!auth()->user()) close_icon @endif">
    <nav>
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    @if(auth()->user()->is_admin != 1)
                        ...
                        <li class="dropdown">
                            <a class="nav-link menu-title link-nav {{routeActive('settings.index')}}" href="{{ route('settings.index') }}"><i data-feather="settings"></i><span>Settings</span></a>
                        </li>
                    ...
                    @else
                        ...
                        {{-- <li class="dropdown">
                            <a class="nav-link menu-title {{ prefixActive('/widgets') }}" href="javascript:void(0)"><i data-feather="airplay"></i><span>Monitoring</span></a>
                        ...
                        <li class="dropdown">
                            <a class="nav-link menu-title link-nav {{routeActive('borrow-books.index')}}" href="{{ route('borrow-books.index') }}"><i data-feather="book"></i><span>Borrow Books</span></a>
                        </li>
                        <li class="dropdown">
                            <a class="nav-link menu-title link-nav {{routeActive('book-return.index')}}" href="{{ route('book-return.index') }}"><i data-feather="log-in"></i><span>Book Return</span></a>
                        </li>
                        ...
                        {{-- <li class="dropdown">
                            <a class="nav-link menu-title link-nav {{routeActive('borrow')}}" href="{{ route('borrow') }}"><i data-feather="book-open"></i><span>Borrow Books</span></a>
                        </li> --}}
                    @endif
                    {{-- <li class="sidebar-main-title">
                        <div>
